...
You create keys from the Vook web app under **Settings**, so there is nothing to
...
<Card title="Get an API key" icon="key" href="https://www.vook.ai/settings/infos">
  Open Settings in the Vook web app to create and manage your keys.
</Card>
...
- Revoke a key at any time from **Settings** in the web app.
