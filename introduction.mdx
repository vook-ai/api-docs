...
The Vook API lets you work with your transcriptions programmatically: list them,
check their status, read the transcript text, and download exports, using only
an API key.
