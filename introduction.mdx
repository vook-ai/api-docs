...
Every request and response field is `snake_case`, on resources, list pages,
and error bodies alike. Timestamps are ISO 8601 strings. Failed requests share
one error body with a stable `code`; see [Errors and limits](/errors).
