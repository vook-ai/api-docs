...
<Steps>
  ...
  <Step title="Transcribe">
    Upload a file or pass a direct link to one, start a transcription job, then
    poll it or receive a [webhook](/webhooks) when the transcript is ready. Full
    walkthroughs in [Transcribe from a file](/upload) and
    [Transcribe from a URL](/transcribe-url).
  </Step>
